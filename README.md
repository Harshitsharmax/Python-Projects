...
5. Face Recognition Attendance System: A moderate-level program that uses face recognition to record attendance. It uses the face_recognition library for face    recognition and attendance management.
